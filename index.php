...
// Création des tables si elles n'existent pas (PostgreSQL)
$sql_users = "CREATE TABLE IF NOT EXISTS users (
    ...
    nom VARCHAR(100),
    prenom VARCHAR(100),
    role VARCHAR(20) CHECK (role IN ('etudiant', 'enseignant')) NOT NULL DEFAULT 'etudiant',
...
$pdo->exec("CREATE INDEX IF NOT EXISTS idx_user_id ON term_suggestions(user_id)");
$pdo->exec("CREATE INDEX IF NOT EXISTS idx_approved_by ON term_suggestions(approved_by)");
